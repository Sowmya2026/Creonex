...
import { Mail, Calendar, Search, CheckCircle, Clock, Trash2, Eye, X } from 'lucide-react';
...
const InquiriesPage = () => {
    ...
    const handleStatusChange = async (id, newStatus) => {
        try {
            ...
            await fetchInquiries();
            // If viewing this inquiry, update the view as well
                                    ...
                                    filteredInquiries.map((inquiry) => (
                                        <tr key={inquiry.id} style={{
                                            ...
                                            <td>
                                                ...
                                                {inquiry.company && <div style={{ fontSize: '0.8rem', color: '#666' }}>{inquiry.company}</div>}
                                            </td>
                                            <td>
                                                <span style={{
                                                    padding: '4px 8px',
                                                    borderRadius: '4px',
                                                    fontSize: '0.75rem',
                                                    backgroundColor: inquiry.subject?.startsWith('Inquiry about:') ? '#fff3e0' :
                                                        inquiry.type === 'collaboration' ? '#e3f2fd' :
                                                            inquiry.type === 'consultation' ? '#f3e5f5' : '#f5f5f5',
                                                    color: inquiry.subject?.startsWith('Inquiry about:') ? '#e65100' :
                                                        inquiry.type === 'collaboration' ? '#1565c0' :
                                                            inquiry.type === 'consultation' ? '#7b1fa2' : '#616161',
                                                    fontWeight: '600'
                                                }}>
                                                    {inquiry.subject?.startsWith('Inquiry about:')
                                                        ? inquiry.subject.replace('Inquiry about:', '').trim()
                                ...
                                <div key={inquiry.id} className="mobile-inquiry-card" style={{
                                    ...
                                    <div className="mobile-card-header">
                                        <div>
                                            ...
                                            {inquiry.company && <div style={{ fontSize: '0.85rem', color: '#666' }}>{inquiry.company}</div>}
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(100px, auto) 1fr', gap: '1rem', alignItems: 'baseline' }}>
                                <span style={{ fontWeight: '600', color: '#666' }}>Inquiry ID:</span>
                                <span style={{ fontFamily: 'monospace', color: '#888', wordBreak: 'break-all' }}>{viewInquiry.id}</span>
                            </div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(100px, auto) 1fr', gap: '1rem', alignItems: 'baseline' }}>
                                ...
                                <div>
                                    ...
                                    {viewInquiry.company && <div style={{ color: '#666' }}>{viewInquiry.company}</div>}
                                </div>
                            </div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(100px, auto) 1fr', gap: '1rem', alignItems: 'baseline' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                        ...
                                        <a href={`mailto:${viewInquiry.email}`} className="text-link" style={{ wordBreak: 'break-all' }}>{viewInquiry.email}</a>
                                    </div>
                                    {viewInquiry.phone && (
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                            <span style={{ fontWeight: 'bold' }}>Ph:</span>
                                            <a href={`tel:${viewInquiry.phone}`} className="text-link">{viewInquiry.phone}</a>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(100px, auto) 1fr', gap: '1rem', alignItems: 'baseline' }}>
                                ...
                                <span style={{
                                    ...
                                    {viewInquiry.subject?.startsWith('Inquiry about:')
                                        ? viewInquiry.subject.replace('Inquiry about:', '').trim()
                                        : (viewInquiry.type || 'General')}
                                </span>
                            </div>
